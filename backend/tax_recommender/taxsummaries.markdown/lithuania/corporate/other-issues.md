...
*Please see* *Controlled foreign companies (CFCs)* *in the [Group taxation](group-taxation.html) section for more information*.

### Limitation on interest deductions

*Please see* *Thin capitalisation and EBITDA rules* *in the [Group taxation](group-taxation.html) section for more information.*

### Mandatory disclosure rules (DAC6)

*Please see* *DAC6 implementation* *in the [Tax administration](../../lithuania%3FtopicTypeId=c3980974-40d6-4ba4-8a3e-eba74cf5f5b9.html) section* *for more information.*
