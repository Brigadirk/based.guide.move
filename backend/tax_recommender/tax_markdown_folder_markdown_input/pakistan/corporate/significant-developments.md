...
* 25% of sales promotion and advertising expense are to be disallowed in case of royalty arrangement with an associated entity on account of certain intangibles (*please see the* *[Group taxation](group-taxation.html) section for details*).
...
* A concept of ‘significant economic presence’ of a non-resident has been introduced by defining the term of a ‘business connection in Pakistan’. Non-residents covered under a double tax treaty (DTT) shall not be affected with this development (*please see the [Corporate residence](corporate-residence.html) section for details*).
* [Overview](../../pakistan.html)
