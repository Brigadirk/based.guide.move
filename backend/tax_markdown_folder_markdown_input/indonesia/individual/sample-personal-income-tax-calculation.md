...
Notes
* House rentals and interest from time deposits are subject to a final income tax, thus they are no longer included in the above calculation (*see Interest income in the [Income determination](income-determination.html) section*).
* Gains from redemption of mutual funds are not subject to tax (*see Exempt income in the [Income determination](income-determination.html) section*).
