...
Generally, foreign WHT can be credited against Austrian CIT (*see Foreign income in the [Income determination](../../austria%3FtopicTypeId=acb0dfca-7ffb-4322-9fd9-f9f8521a016c.html) section*). In special cases (e.g. Brazil, China, Korea), the DTT provides for a matching credit, which allows the credit of a pre-defined amount that exceeds the actually paid foreign WHT.
