...
* The adoption of new approved tax returns, specifically adopted for each category of business for the annual income tax return. All taxpayers are required to use these forms exclusively to declare their results for the financial year ending 31 December. There are three types of forms: (i) one form for taxpayers subject to corporate income tax (CIT) and individuals subject to tax on business profits of physical persons (*impôts sur les bénéfices d’affaires des personnes physiques* or IBAPP), (ii) one form for use by financial and bank establishments, and (iii) one form for taxpayers subject to the flat rate regime.


* [Overview](../../mauritania.html)
* [Corporate - Taxes on corporate income](../../mauritania%3FtopicTypeId=c12cad9f-d48e-4615-8593-1f45abaa4886.html)
