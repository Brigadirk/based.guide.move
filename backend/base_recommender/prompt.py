def prompt_tax_rundown(tax_profile_json):
    ...
    prompt_template = f"""
        ...
        individual in their "desiredCountry" for the next full tax year.

        All the necessary financial and personal information for this individual 
        is provided in the following JSON profile.  
        
        You **must** base your tax rundown **exclusively** on the data provided 
        in this JSON. Do not make assumptions or bring in outside information.
