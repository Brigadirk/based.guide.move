...
import { getLanguages, getAllLanguages } from "@/lib/utils/country-utils"
...
export function Education({ onComplete }: { onComplete: () => void }) {
  ...
  const BeautifulTabs = ({ children, defaultValue = "you", tabKey }: { children: React.ReactNode, defaultValue?: string, tabKey: string }) => (
    <Tabs key={tabKey} defaultValue={defaultValue} className="w-full">
        ...
        <CardContent className="pt-6">
          <div className="space-y-6">
            ...
            <div className="space-y-6">
              ...
              {hasPartnerSelected ? (
                <BeautifulTabs tabKey="degrees-section-isolated">
          ...
          <div className="space-y-6">
              <div className="flex items-center gap-3">
                <Award className="w-5 h-5 text-blue-600" />
                        <h3 className="text-lg font-semibold">Skills & Credentials</h3>
              </div>
              
                      {hasPartnerSelected ? (
                        <BeautifulTabs tabKey="skills">
                          <TabsContent value="you" className="mt-6 space-y-6 animate-in fade-in-50 duration-300">
                            {/* Your Skills */}
            {skills.length > 0 && (
              <div className="space-y-4">
                            ...
                            <div className="space-y-4 p-4 border rounded-lg bg-card">
                              ...
                              <div className="space-y-4">
                                <div className="space-y-2">
                                  <Label>Skill or profession *</Label>
                                  <Input
                                    placeholder="e.g., Marketing, Teaching, Engineering..."
                                    value={skillDraft.skill}
                                    onChange={(e) => setSkillDraft({...skillDraft, skill: e.target.value})}
                                  />
                                </div>
                                <div className="grid md:grid-cols-2 gap-4">
                                  <div className="space-y-2">
                                    <Label>Credential name</Label>
                                    <Input
                                      placeholder="e.g., TEFL, PMP, Chartered Engineer"
                                      value={skillDraft.credentialName}
                                      onChange={(e) => setSkillDraft({...skillDraft, credentialName: e.target.value})}
                                    />
                                  </div>
                                ...
                                <Button
                                  onClick={() => {
                                    setPartnerSkills([...partnerSkills, skillDraft])
                                    setSkillDraft({skill: "", credentialName: "", credentialInstitute: ""})
                                  }}
                                  className="w-full"
                                >
          ...
          <div className="space-y-6">
                <div className="flex items-center gap-3">
                  ...
                  <h3 className="text-lg font-semibold">Work Experience</h3>
                      ...
                      {hasPartnerSelected ? (
                        <BeautifulTabs tabKey="work-experience">
                          <TabsContent value="you" className="mt-6 space-y-6 animate-in fade-in-50 duration-300">
                 ...
                 >
                  ...
                  Add Work Experience
                          ...
                          <TabsContent value="partner" className="mt-6 space-y-6 animate-in fade-in-50 duration-300">
                            ...
                            {(() => {
                              const partnerWorkExp = getFormData("education.partner.workExperience") ?? []
                              return partnerWorkExp.length > 0 && (
                                <div className="space-y-4">
                                  <h4 className="font-medium text-base">Partner Work Experience</h4>
                                  <div className="grid gap-4">
                                    {partnerWorkExp.map((job: any, idx: number) => (
                                      <div key={idx} className="p-4 border rounded-lg bg-card">
                                        <div className="flex items-start justify-between mb-3">
                                          <div className="flex-1">
                                            <div className="flex items-center gap-3 mb-2">
                                          ...
                                          <Button
                                            ...
                                            size="sm"
                                            onClick={() => {
                                              const updated = partnerWorkExp.filter((_: any, i: number) => i !== idx)
                                              updateFormData("education.partner.workExperience", updated)
                                            }}
                                          >
                                            <Trash2 className="w-4 h-4" />
                                          </Button>
                            ...
                            {/* Add Partner Work Experience */}
                            <div className="space-y-4 p-4 border rounded-lg bg-card">
                              <h4 className="font-medium text-base">Add Partner Work Experience</h4>
                              <div className="space-y-4">
                                <div className="grid md:grid-cols-2 gap-4">
                                  <div className="space-y-2">
                                    <Label>Job title *</Label>
                                ...
                                <Button
                                  disabled={!workExpDraft.jobTitle || !workExpDraft.company || !workExpDraft.country || !workExpDraft.startDate || (!workExpDraft.current && !workExpDraft.endDate)}
                                  onClick={() => {
                                    const currentExp = getFormData("education.partner.workExperience") ?? []
                                    updateFormData("education.partner.workExperience", [...currentExp, workExpDraft])
                                    setWorkExpDraft({jobTitle: "", company: "", country: "", startDate: "", endDate: "", current: false})
                                  }}
                                  className="w-full"
                                >
                        ...
                        <div className="space-y-6">
                          {/* Your Work Experience - Single User Mode */}
                          {(() => {
                            const workExp = getFormData("education.workExperience") ?? []
                            return workExp.length > 0 && (
                              <div className="space-y-4">
                          ...
                          {/* Add work experience form - Single User Mode */}
                          <div className="space-y-4 p-4 border rounded-lg bg-card">
                            <h4 className="font-medium text-base">Add Work Experience</h4>
                            <div className="space-y-4">
                              <div className="grid md:grid-cols-2 gap-4">
                              ...
                              <div className="flex items-center gap-2">
                                <Checkbox 
                                  id="current_job_single" 
                                  checked={workExpDraft.current}
                                  onCheckedChange={(v) => setWorkExpDraft({...workExpDraft, current: !!v, endDate: v ? "" : workExpDraft.endDate})}
                                />
                                <Label htmlFor="current_job_single">This is my current job</Label>
                              </div>
                              <Button
                                disabled={!workExpDraft.jobTitle || !workExpDraft.company || !workExpDraft.country || !workExpDraft.startDate || (!workExpDraft.current && !workExpDraft.endDate)}
                                onClick={() => {
          ...
          <div className="space-y-6">
                <div className="flex items-center gap-3">
                  ...
                  <h3 className="text-lg font-semibold">Professional Licenses</h3>
                      ...
                      {hasPartnerSelected ? (
                        <BeautifulTabs tabKey="professional-licenses">
                          <TabsContent value="you" className="mt-6 space-y-6 animate-in fade-in-50 duration-300">
            ...
            <div className="space-y-4 p-4 border rounded-lg bg-card">
                 ...
                 >
                  ...
                  Add Professional License
                          ...
                          <TabsContent value="partner" className="mt-6 space-y-6 animate-in fade-in-50 duration-300">
                            ...
                            {(() => {
                              const partnerLicenses = getFormData("education.partner.professionalLicenses") ?? []
                              return partnerLicenses.length > 0 && (
                                <div className="space-y-4">
                                  <h4 className="font-medium text-base">Partner Professional Licenses</h4>
                                  <div className="grid gap-4">
                                    {partnerLicenses.map((license: any, idx: number) => (
                                      <div key={idx} className="p-4 border rounded-lg bg-card">
                                        <div className="flex items-start justify-between mb-3">
                                          <div className="flex-1">
                                            <div className="flex items-center gap-3 mb-2">
                                          ...
                                          <Button
                                            ...
                                            size="sm"
                                            onClick={() => {
                                              const updated = partnerLicenses.filter((_: any, i: number) => i !== idx)
                                              updateFormData("education.partner.professionalLicenses", updated)
                                            }}
                                          >
                                            <Trash2 className="w-4 h-4" />
                                          </Button>
                            ...
                            {/* Add Partner Professional License */}
                            <div className="space-y-4 p-4 border rounded-lg bg-card">
                              <h4 className="font-medium text-base">Add Partner Professional License</h4>
                              <div className="space-y-4">
                                <div className="grid md:grid-cols-2 gap-4">
                                  <div className="space-y-2">
                                    <Label>License type *</Label>
                                    <Input
                                      placeholder="e.g., Teaching License, Engineering License"
                                      value={licenseDraft.licenseType}
                                      onChange={(e) => setLicenseDraft({...licenseDraft, licenseType: e.target.value})}
                                    />
                                  </div>
                                ...
                                <div className="grid md:grid-cols-2 gap-4">
                                  <div className="space-y-2">
                                    <Label>Issuing body *</Label>
                                    <Input
                                      placeholder="e.g., Professional Engineers Board"
                                      value={licenseDraft.issuingBody}
                                      onChange={(e) => setLicenseDraft({...licenseDraft, issuingBody: e.target.value})}
                                    />
                                  </div>
                                ...
                                <Button
                                  disabled={!licenseDraft.licenseType || !licenseDraft.licenseName || !licenseDraft.issuingBody || !licenseDraft.country}
                                  onClick={() => {
                                    const currentLicenses = getFormData("education.partner.professionalLicenses") ?? []
                                    updateFormData("education.partner.professionalLicenses", [...currentLicenses, licenseDraft])
                                    setLicenseDraft({licenseType: "", licenseName: "", issuingBody: "", country: "", active: false})
                                  }}
                                  className="w-full"
                                >
                        ...
                        <div className="space-y-6">
                          {/* Your Professional Licenses - Single User Mode */}
                          {(() => {
                            const licenses = getFormData("education.professionalLicenses") ?? []
                            return licenses.length > 0 && (
                              <div className="space-y-4">
                          ...
                          {/* Add professional license form - Single User Mode */}
                          <div className="space-y-4 p-4 border rounded-lg bg-card">
                            <h4 className="font-medium text-base">Add Professional License</h4>
                            <div className="space-y-4">
                              <div className="grid md:grid-cols-2 gap-4">
                              ...
                              <div className="flex items-center gap-2">
                                <Checkbox 
                                  id="license_active_single"
                                  checked={licenseDraft.active}
                                  onCheckedChange={(v) => setLicenseDraft({...licenseDraft, active: !!v})}
                                />
                                <Label htmlFor="license_active_single">License is currently active</Label>
                              </div>
                              <Button
                                disabled={!licenseDraft.licenseType || !licenseDraft.licenseName || !licenseDraft.issuingBody || !licenseDraft.country}
                                onClick={() => {
              ...
              <div className="space-y-6">
                <div className="flex items-center gap-3">
                  ...
                  <h3 className="text-lg font-semibold">Military Service</h3>
                      ...
                      {hasPartnerSelected ? (
                        <BeautifulTabs tabKey="military-service">
                          <TabsContent value="you" className="mt-6 space-y-6 animate-in fade-in-50 duration-300">
                ...
                {getFormData("education.militaryService.hasService") && (
                  <div className="space-y-4 p-4 border rounded-lg bg-card">
                    ...
                    <div className="space-y-2">
                      ...
                      />
                        ...
                        <div className="space-y-6">
                          {/* Your Military Service - Single User Mode */}
                          <div className="flex items-center gap-3 p-4 border rounded-lg bg-card">
                            <Checkbox
                  ...
                  <TabsContent value="partner" className="mt-6 space-y-6 animate-in fade-in-50 duration-300">
                    ...
                    {/* Partner Work Experience Section */}
                    <div className="space-y-6">
                      <div className="flex items-center gap-3">
                        <Users className="w-5 h-5 text-green-600" />
                        <h3 className="text-lg font-semibold">Partner Work Experience</h3>
                      </div>

                      {/* Partner work experience placeholder for now */}
                      <div className="p-4 border rounded-lg bg-muted/30 text-center">
                        <p className="text-sm text-muted-foreground">
                          Partner work experience tracking coming soon
                        </p>
                      </div>
                    </div>
                    ...
                    {/* Partner Professional Licenses Section */}
                    <div className="space-y-6">
                      <div className="flex items-center gap-3">
                        <Shield className="w-5 h-5 text-purple-600" />
                        <h3 className="text-lg font-semibold">Partner Professional Licenses</h3>
                      </div>
                      
                      <div className="p-4 border rounded-lg bg-muted/30 text-center">
                        <p className="text-sm text-muted-foreground">
                          Partner license tracking coming soon
                        </p>
                      </div>
                    </div>
                    ...
                    {/* Partner Military Service Section */}
                    <div className="space-y-6">
                      <div className="flex items-center gap-3">
                        <Shield className="w-5 h-5 text-red-600" />
                        <h3 className="text-lg font-semibold">Partner Military Service</h3>
                      </div>
                      
                      <div className="p-4 border rounded-lg bg-muted/30 text-center">
                        <p className="text-sm text-muted-foreground">
                          Partner military service tracking coming soon
                        </p>
                      </div>
                    </div>
                  </div>
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-4 p-4 border rounded-lg bg-card">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-center gap-2">
                        <Checkbox 
                          id="current_job_no_partner" 
                          checked={workExpDraft.current}
                          onCheckedChange={(v) => setWorkExpDraft({...workExpDraft, current: !!v, endDate: v ? "" : workExpDraft.endDate})}
                        />
                        <Label htmlFor="current_job_no_partner">This is my current job</Label>
                      </div>
                      <Button
                        disabled={!workExpDraft.jobTitle || !workExpDraft.company || !workExpDraft.country || !workExpDraft.startDate || (!workExpDraft.current && !workExpDraft.endDate)}
                        onClick={() => {
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-4 p-4 border rounded-lg bg-card">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-center gap-2">
                        <Checkbox 
                          id="license_active_no_partner"
                          checked={licenseDraft.active}
                          onCheckedChange={(v) => setLicenseDraft({...licenseDraft, active: !!v})}
                        />
                        <Label htmlFor="license_active_no_partner">License is currently active</Label>
                      </div>
                      <Button
                        disabled={!licenseDraft.licenseType || !licenseDraft.licenseName || !licenseDraft.issuingBody || !licenseDraft.country}
                        onClick={() => {
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-center gap-3 p-4 border rounded-lg bg-card">
                    <Checkbox
                      id="has_military_no_partner"
                      checked={getFormData("education.militaryService.hasService") ?? false}
                      onCheckedChange={(v) => updateFormData("education.militaryService.hasService", !!v)}
                    />
                    <Label htmlFor="has_military_no_partner" className="text-base font-medium">
                      I have served in the military
                    </Label>
                  </div>
                  ...
                  {getFormData("education.militaryService.hasService") && (
                    <div className="space-y-4 p-4 border rounded-lg bg-card">
                      ...
                      <div className="flex items-center gap-2">
                        <Checkbox
                          id="currently_serving_no_partner"
                          checked={getFormData("education.militaryService.currentlyServing") ?? false}
                          onCheckedChange={(v) => updateFormData("education.militaryService.currentlyServing", !!v)}
                        />
                        <Label htmlFor="currently_serving_no_partner">Currently serving</Label>
                      </div>
                      <div className="grid md:grid-cols-2 gap-4">
                        <div className="space-y-2">
                          <Label>Rank achieved</Label>
        ...
        <CardContent className="pt-6">
          <div className="space-y-6">
            ...
            <div className="space-y-6">
              ...
              {hasPartnerSelected ? (
                <BeautifulTabs tabKey="study-plans">
                  <TabsContent value="you" className="mt-6 space-y-6 animate-in fade-in-50 duration-300">
                    {/* Your Study Plans */}
            <div className="flex items-center gap-3 p-4 border rounded-lg bg-card">
              <Checkbox
            ...
            {interestedInStudy && (
              <div className="space-y-4 p-4 border rounded-lg bg-card">
                <div className="space-y-2">
                  ...
                  <TabsContent value="partner" className="mt-6 space-y-6 animate-in fade-in-50 duration-300">
                    ...
                    <div className="flex items-center gap-3 p-4 border rounded-lg bg-card">
                      ...
                      />
                      <Label htmlFor="partner_interested_study" className="text-base font-medium">
                    ...
                    {getFormData("education.partner.interestedInStudying") && (
                      <div className="space-y-4 p-4 border rounded-lg bg-card">
                        <div className="space-y-2">
                          <Label>Partner's study details</Label>
                          <Textarea
                            placeholder="Describe what partner would like to study, preferred institutions, program types..."
                ...
                <div className="space-y-6">
                  {/* Your Study Plans - Single User Mode */}
                  <div className="flex items-center gap-3 p-4 border rounded-lg bg-card">
                    <Checkbox
                      id="interested_study_single"
                      checked={interestedInStudy}
                      onCheckedChange={(v) => setInterested(!!v)}
                    />
                    <Label htmlFor="interested_study_single" className="text-base font-medium">
                      I'm interested in studying in {countryPhrase}
                    </Label>
                  </div>
          ...
          <div className="space-y-6">
              ...
              {hasPartnerSelected ? (
                <BeautifulTabs tabKey="school-offers">
                  <TabsContent value="you" className="mt-6 space-y-6 animate-in fade-in-50 duration-300">
                    {/* Your School Offers */}
              ...
              <div className="space-y-4">
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <TabsContent value="partner" className="mt-6 space-y-6 animate-in fade-in-50 duration-300">
                    ...
                    {(() => {
                      const partnerSchoolOffers = getFormData("education.partner.schoolOffers") ?? []
                      return partnerSchoolOffers.length > 0 && (
                        <div className="space-y-4">
                          <h4 className="font-medium text-base">Partner School Offers</h4>
                          <div className="grid gap-4">
                            {partnerSchoolOffers.map((offer: any, idx: number) => (
                              <div key={idx} className="p-4 border rounded-lg bg-card">
                                <div className="flex items-start justify-between mb-3">
                                  <div className="flex-1">
                                    <h5 className="font-medium mb-1">{offer.program}</h5>
                                  ...
                                  <Button variant="ghost" size="sm" onClick={() => {
                                    const updated = partnerSchoolOffers.filter((_: any, i: number) => i !== idx)
                                    updateFormData("education.partner.schoolOffers", updated)
                                  }}>
                                    <Trash2 className="w-4 h-4" />
                                  </Button>
                                </div>
                    ...
                    {/* Add Partner School Offer */}
                    <div className="space-y-4 p-4 border rounded-lg bg-card">
                      <h4 className="font-medium text-base">Add Partner School Offer</h4>
                      <div className="space-y-4">
                        <div className="grid md:grid-cols-2 gap-4">
                          <div className="space-y-2">
                            <Label>School/University *</Label>
                          ...
                          <div className="space-y-2">
                            <Label>Program/Course *</Label>
                            <Input placeholder="e.g., Master of Arts" value={offerDraft.program} onChange={(e) => setOfferDraft({...offerDraft, program: e.target.value})} />
                          </div>
                        </div>
                        <div className="grid md:grid-cols-2 gap-4">
                          <div className="space-y-2">
                        ...
                        <Button disabled={!canAddOffer} onClick={() => { 
                          const currentOffers = getFormData("education.partner.schoolOffers") ?? []
                          updateFormData("education.partner.schoolOffers", [...currentOffers, offerDraft])
                ...
                <div className="space-y-6">
                  {/* Your School Offers - Single User Mode */}
                  {schoolOffers.length > 0 && (
                    <div className="space-y-4">
                      <h4 className="font-medium text-base">Your School Offers</h4>
                      <div className="grid gap-4">
                  ...
                  {/* Add School Offer - Single User Mode */}
                  <div className="space-y-4 p-4 border rounded-lg bg-card">
                    <h4 className="font-medium text-base">Add School Offer</h4>
                    <div className="space-y-4">
                      <div className="grid md:grid-cols-2 gap-4">
          ...
          <div className="space-y-6">
              ...
              {hasPartnerSelected ? (
                <BeautifulTabs tabKey="learning-goals">
                  <TabsContent value="you" className="mt-6 space-y-6 animate-in fade-in-50 duration-300">
                    {/* Your Learning Goals */}
              ...
              <div className="space-y-4">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <TabsContent value="partner" className="mt-6 space-y-6 animate-in fade-in-50 duration-300">
                    ...
                    {(() => {
                      const partnerLearningInterests = getFormData("education.partner.learningInterests") ?? []
                      return partnerLearningInterests.length > 0 && (
                        <div className="space-y-4">
                          <h4 className="font-medium text-base">Partner Learning Goals</h4>
                          <div className="grid gap-4">
                            {partnerLearningInterests.map((interest: any, idx: number) => (
                              <div key={idx} className="p-4 border rounded-lg bg-card">
                                <div className="flex items-start justify-between mb-3">
                                  <div className="flex-1">
                                    <div className="flex items-center gap-3 mb-2">
                                  ...
                                  <Button variant="ghost" size="sm" onClick={() => {
                                    const updated = partnerLearningInterests.filter((_: any, i: number) => i !== idx)
                                    updateFormData("education.partner.learningInterests", updated)
                                  }}>
                                    <Trash2 className="w-4 h-4" />
                                  </Button>
                                </div>
                    ...
                    {/* Add Partner Learning Goal */}
                    <div className="space-y-4 p-4 border rounded-lg bg-card">
                      <h4 className="font-medium text-base">Add Partner Learning Goal</h4>
                      <div className="space-y-4">
                        <div className="space-y-2">
                          <Label>Skill or subject *</Label>
                          <Input placeholder="e.g., French Language, Project Management, Cooking..." value={interestDraft.skill} onChange={(e) => setInterestDraft({...interestDraft, skill: e.target.value})} />
                        </div>
                        <div className="space-y-2">
                          <Label>Commitment level *</Label>
                          <Select value={interestDraft.status} onValueChange={(v) => setInterestDraft({...interestDraft, status: v as "planned" | "open"})}>
                            <SelectTrigger><SelectValue /></SelectTrigger>
                            <SelectContent>
                              <SelectItem value="planned">Partner has concrete plans to learn this</SelectItem>
                              <SelectItem value="open">Partner is open to learning this</SelectItem>
                            </SelectContent>
                          </Select>
                        </div>
                        <div className="grid md:grid-cols-2 gap-4">
                        ...
                        <Button disabled={!canAddInterest} onClick={() => { 
                          const currentInterests = getFormData("education.partner.learningInterests") ?? []
                          updateFormData("education.partner.learningInterests", [...currentInterests, interestDraft])
                ...
                <div className="space-y-6">
                  {/* Your Learning Goals - Single User Mode */}
                  {learningInterests.length > 0 && (
                    <div className="space-y-4">
                      <h4 className="font-medium text-base">Your Learning Goals</h4>
                      <div className="grid gap-4">
                  ...
                  {/* Add Learning Goal - Single User Mode */}
                  <div className="space-y-4 p-4 border rounded-lg bg-card">
                    <h4 className="font-medium text-base">Add Learning Goal</h4>
                    <div className="space-y-4">
                      <div className="space-y-2">
            ...
            <div className="flex gap-3 items-end">
              <div className="flex-1">
                ...
                <Select 
                  ...
                  onValueChange={(value) => setNewTeachingLang({...newTeachingLang, language: value})}
                >
                  <SelectTrigger>
